...
int main(int argc, char * argv[]) {
	char c, buff[DIM_BUFF];
	int readSocket, numLinea, contaLinea = 1, portNumber, i, pid, peeraddrLen;
	...
	while (1) {
		...
		if (pid < 0) {
			...
			// L'algoritmo commentato è una variante di quello usato, con lettura carattere per carattere
